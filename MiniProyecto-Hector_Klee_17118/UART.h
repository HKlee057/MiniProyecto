...
#include "driverlib/uart.h"                 // Defines y Macros para UART

#include "uartStdio/uartstdio.h"            // Prototypes for the UART console functions

/* ------------------------      Funciones Prototipo     --------------------- */
void
uart_init(void);                       // Iniciliazacion de pin de sensor

void
uart_int_handler(void);                // Funcion de cambio de color a haber deteccion
